...
- Implementar la carga y asignación de texturas en formato `.png` para paredes. En el caso del suelo y el cielo, se establecerá un color usando nuestro propio desarrollo de una función que maneja rgb.
